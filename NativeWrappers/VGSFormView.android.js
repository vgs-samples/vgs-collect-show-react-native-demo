...
export default class VGSFormView extends Component<Props> {
  constructor(props) {
    ...
    this.listener = DeviceEventEmitter.addListener(
      'VGSCollectOnVGSResponse',
      e => this.showUserData(e),
    );
    this.listener = DeviceEventEmitter.addListener('cardNumberToken', e =>
      this.showCardNumberToken(e),
    );
    this.listener = DeviceEventEmitter.addListener('expirationDateToken', e =>
      this.showExpirationDateToken(e),
    );
    this.state = {
      bodyText: 'Code:',
      cardNumberToken: ' ',
